...
<li class="nav-item {{ request()->routeIs('paciente.*') ? 'active' : '' }}">
  <a href="{{ route('paciente.index') }}" class="nav-link">
     <i class="typcn typcn-user-outline"></i> Pacientes
  </a>
</li>

<li class="nav-item {{ request()->routeIs('medicamento.*') ? 'active' : '' }}">
  <a href="{{ route('medicamento.index') }}" class="nav-link">
     <i class="typcn typcn-heart-outline"></i> Medicamentos
  </a>
</li>

<li class="nav-item {{ request()->routeIs('prescricao.*') ? 'active' : '' }}">
  <a href="{{ route('prescricao.index') }}" class="nav-link">
     <i class="typcn typcn-document-text"></i> Prescrições
  </a>
</li>

<li class="nav-item {{ request()->routeIs('funcionario.*') ? 'active' : '' }}">
  <a href="{{ route('funcionario.index') }}" class="nav-link">
     <i class="typcn typcn-group-outline"></i> Funcionários
  </a>
</li>

<li class="nav-item {{ request()->routeIs('administracao.*') ? 'active' : '' }}">
  <a href="{{ route('administracao.index') }}" class="nav-link">
     <i class="typcn typcn-cog-outline"></i> Administração
  </a>
</li>

<li class="nav-item {{ request()->routeIs('relatorio.*') ? 'active' : '' }}">
  <a href="{{ route('relatorio.index') }}" class="nav-link">
     <i class="typcn typcn-chart-bar-outline"></i> Relatórios
  </a>
</li>
...
<i class="typcn typcn-power-outline"></i>Sair</button>
                </form>




              <!-- <a href="page-signin.html" class="dropdown-item"><i class="typcn typcn-power-outline"></i> Sign Outa</a> -->
